...
import PrintersImage from "../../public/printers.svg";
...
export const services: PresentationServiceProps[] = [
  {
    title: "Manutenção de Computadores: Dando uma Nova Vida para sua Máquina",
    photo: ComputerImage,
    paragraphs: [
  ...
  {
    title: "Manutenção de Impressoras: A Excelência que Imprime Qualidade",
    photo: PrintersImage,
    paragraphs: [
      "Ampliando nossa gama de serviços, apresentamos a manutenção especializada de impressoras. Sabemos que a impressão é uma parte vital de muitos negócios, e estamos aqui para garantir que sua infraestrutura de impressão funcione perfeitamente.",
      "Confie em nossa experiência para manter sua infraestrutura de impressão operando em sua máxima capacidade. Entre em contato agora e descubra como podemos elevar a qualidade da sua impressão para novos patamares.",
    ],
    features: [
      {
        title: "Diagnóstico Preciso",
        paragraphs: [
          "Nossa equipe realiza diagnósticos precisos para identificar e resolver qualquer problema que sua impressora possa enfrentar. Seja uma questão técnica ou uma necessidade de otimização, estamos prontos para agir.",
        ],
      },
      {
        title: "Manutenção Preventiva",
        paragraphs: [
          "Prevenção é a chave para uma impressão consistente. Oferecemos programas de manutenção preventiva para garantir que suas impressoras estejam sempre em condições ideais, evitando falhas inesperadas e aumentando a durabilidade dos equipamentos.",
        ],
      },
      {
        title: "Reparos Rápidos e Eficientes",
        paragraphs: [
          "e sua impressora apresentar algum problema, nossa equipe age com rapidez e eficiência. Reparamos componentes defeituosos e substituímos peças desgastadas, assegurando que sua impressora volte a funcionar em tempo recorde.",
        ],
      },
      {
        title: "Otimização de Desempenho",
        paragraphs: [
          "Além de resolver problemas, buscamos constantemente maneiras de otimizar o desempenho de suas impressoras. Isso não apenas melhora a qualidade da impressão, mas também reduz custos operacionais a longo prazo.",
        ],
      },
    ],
  },
  ...
  {
    title: "Segurança Residencial: Protegendo o que Mais Importa",
    photo: SecurityImage,
    paragraphs: [
      "Estendendo nosso compromisso com a sua tranquilidade, apresentamos serviços especializados em segurança residencial. Oferecemos instalação de câmeras, travas e equipamentos de última geração para garantir a proteção completa do seu lar.",
      "nvista na segurança do seu lar conosco. Entre em contato agora e descubra como podemos criar um ambiente mais seguro e protegido para você e sua família.",
    ],
    features: [
      {
        title: "Instalação de Câmeras de Vigilância",
        paragraphs: [
          "Proporcione uma visão abrangente da sua propriedade com a instalação estratégica de câmeras de vigilância. Monitore remotamente e tenha paz de espírito, sabendo que sua casa está sempre sob um olhar atento.",
        ],
      },
      {
        title: "Travas e Sistemas de Acesso",
        paragraphs: [
          "Aprimore a segurança da sua residência com travas e sistemas de acesso modernos. Desde fechaduras inteligentes até controles de acesso avançados, oferecemos soluções personalizadas para atender às suas necessidades específicas",
        ],
      },
      {
        title: "Sistemas de Alarme Residencial",
        paragraphs: [
          "Proteja sua casa com sistemas de alarme que detectam qualquer atividade suspeita. Nossas soluções de alarme são projetadas para oferecer uma resposta rápida, mantendo sua propriedade segura em todos os momentos.",
        ],
      },
      {
        title: "Monitoramento Remoto",
        paragraphs: [
          "Acesse sua segurança residencial de qualquer lugar com monitoramento remoto. Esteja sempre conectado, recebendo alertas em tempo real e tendo o controle total da segurança da sua residência na palma da sua mão.",
        ],
      },
    ],
  },
