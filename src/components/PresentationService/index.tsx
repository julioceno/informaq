  ...
  return (
    <div className="grid grid-cols-3 gap-3 md:gap-10">
      <img
        src={photo}
        alt="programming"
        className={`w-full h-36 md:h-96 xl:h-[30rem] 2xl:h-[37rem] object-cover rounded-md ${imageRounded} col-span-3 md:col-span-1 md:${imageOrder}`}
      />
      <div
      ...
      <div className="col-span-3 grid md:grid-cols-2 gap-4 order-last">
